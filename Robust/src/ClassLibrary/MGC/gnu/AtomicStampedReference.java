...
public class AtomicStampedReference/*<V>*/  {
    ...
    private static class ReferenceIntegerPair/*<T>*/ {
        private final Object/*T*/ reference;
        private final int integer;
        ReferenceIntegerPair(Object/*T*/ r, int i) {
     ...
     */
    public AtomicStampedReference(Object/*V*/ initialRef, int initialStamp) {
     ...
     */
    public boolean weakCompareAndSet(Object/*V*/      expectedReference,
     ...
     * @return true if successful
     */
    public boolean compareAndSet(Object/*V*/      expectedReference,
	                         Object/*V*/      newReference,
                                 int    expectedStamp,
                                 int    newStamp) {
        ReferenceIntegerPair/*<V>*/ current = atomicRef.get();
