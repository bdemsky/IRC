...
public class RainForest extends Thread {
  ...
  public void run() {
    ...
    offsets[0] = getoffset{RainForest, land};
    offsets[1] = (short) 0;
    offsets[2] = (short) lowx;
    offsets[3] = (short) (highx - lowx);
    offsets[4] = (short) lowy;
    offsets[5] = (short) (highy - lowy);
    offsets[6] = getoffset{GameMap, tree};
    offsets[7] = (short) 0;
    ...
    if (gamer.getState() == INIT) {
      if (gamer.findGoal(land) < 0) {
        ...
        if(((gamer.getGoalX() - gamer.getX()) > BLOCK) || ((gamer.getGoalY() - gamer.getY()) > BLOCK)) {
          ...
          Object o1 = land;
          short[] offsets1 = new short[6];
          offsets1[0] = (short) lowx;
          offsets1[1] = (short) (highx - lowx);
          offsets1[2] = (short) lowy;
          offsets1[3] = (short) (highy - lowy);
          offsets1[4] = getoffset{GameMap, tree};
          offsets1[5] = (short) 0;
